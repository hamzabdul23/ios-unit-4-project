  ...
  private var numCorrectQuestions = 0
    ...
    override func viewDidLoad() {
        ...
        TriviaQuestionService.shared.fetchTriviaQuestions { [weak self] questions, error in
              ...
              if let questions = questions {
                // Assuming you have fetched exactly five questions
                self.questions = questions
                self.updateQuestion(withQuestionIndex: 0)
              } else if let error = error {
                print("Error fetching questions: \(error)")
    ...
    private func updateQuestion(withQuestionIndex questionIndex: Int) {
        ...
        // For True or False questions, show only 2 buttons
        if answers.count == 2 {
        ...
        // For regular multiple-choice questions, show all 4 buttons
  ...
  private func isCorrectAnswer(_ answer: String) -> Bool {
    ...
    private func showFinalScore() {
        ...
        if presentedViewController == nil {
            ...
            // Present the alert and handle the reset action
